...
import com.example.mcpserver.model.DataAnalysisResult;
import com.example.mcpserver.service.DataAnalysisService;
...
public class DataAnalysisMcpConfiguration {
    ...
    /**
     * Registers the data analysis tools as a tool callback provider.
